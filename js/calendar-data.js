...
CalendarData.festivals = [
    ...
    },
    {
        ...
        end_date: "2025-04-19",
        start_at_sunset: true,
        description_short: "Festividad de siete días donde se come pan sin levadura (15-21 de Aviv)",
        description_long: "La Fiesta de los Panes Sin Levadura comienza el día después de la Pascua y dura siete días. Durante este tiempo, no se debe comer ni tener levadura en el hogar. Esta festividad simboliza la pureza y la eliminación del pecado (representado por la levadura) de nuestras vidas. Esta es la primera festividad alegre después de Passover, celebrando la liberación de Egipto.",
        preparations: [
            "Retirar toda levadura de la casa",
    ...
    },
    {
        ...
        description_short: "Ofrenda de las primicias de la cosecha - SIEMPRE en domingo (16 de Aviv)",
        description_long: "La Fiesta de los Primeros Frutos se celebra el primer día después del sábado durante la semana de los Panes sin Levadura, lo que significa que SIEMPRE cae en domingo. Esta festividad marca el comienzo de la cosecha de cebada y simboliza la consagración de toda la cosecha a Dios. Proféticamente representa la resurrección del Mesías, quien resucitó en domingo. Este día marca el inicio del conteo de 50 días hacia Shavuot (Pentecostés).",
        preparations: [
    ...
    },
    {
        ...
        end_date: null,
        start_at_sunset: true,
        description_short: "Celebración de la entrega de la Torah - SIEMPRE en domingo (50 días después de Primicias)",
        description_long: "Shavuot, también conocido como la Fiesta de las Semanas o Pentecostés, se celebra exactamente 50 días después de la Fiesta de los Primeros Frutos (contando Primicias como día 1). Como Primicias siempre es domingo, Shavuot también SIEMPRE cae en domingo. Conmemora la entrega de la Torah en el Monte Sinaí y marca el final de la cosecha de cebada y el comienzo de la cosecha de trigo. En el Nuevo Testamento, esta festividad también marca el derramamiento del Espíritu Santo sobre los discípulos.",
        preparations: [
    ...
    },
    {
        ...
        end_date: null,
        start_at_sunset: true,
        description_short: "Día de tocar el shofar (cuerno de carnero) - 1º de Tishri",
        description_long: "Yom Teruah marca el inicio del séptimo mes del calendario hebreo (Tishri). Es un día señalado para el toque de trompetas (shofar), anunciando un tiempo de reflexión y preparación para los Días de Temor Reverencial que culminan con Yom Kippur. También conocido como Rosh Hashaná en el judaísmo rabínico. Este día puede caer en cualquier día de la semana.",
        preparations: [
            "Preparar el shofar",
    ...
    },
    {
        ...
        end_date: null,
        start_at_sunset: true,
        description_short: "Día más solemne del año, dedicado al arrepentimiento - 10º de Tishri",
        description_long: "Yom Kippur es el día más solemne en el calendario bíblico. Es un día de ayuno total, oración y arrepentimiento que ocurre exactamente diez días después de Yom Teruah (contando Yom Teruah como día 1). Históricamente, era el único día del año en que el Sumo Sacerdote podía entrar al Lugar Santísimo del Tabernáculo para ofrecer sacrificio por los pecados de todo el pueblo. Es un Sabbat sagrado con descanso obligatorio.",
        preparations: [
    ...
    },
    {
        ...
        end_date: "2025-10-13",
        start_at_sunset: true,
        description_short: "Conmemoración de la protección divina durante los 40 años en el desierto - 15-21 de Tishri",
        description_long: "Sukkot es una festividad de siete días que comienza cinco días después de Yom Kippur (el día 15 de Tishri). Conmemora cómo el pueblo de Israel vivió en cabañas temporales (sukkot) durante sus 40 años de peregrinación en el desierto. Es un tiempo de regocijo y celebración por la protección y provisión divina. También conocida como la Fiesta de las Cabañas o Fiesta de la Cosecha. IMPORTANTE: Debe ocurrir después del equinoccio otoñal para que haya frutas de cosecha disponibles (dátiles, granadas, higos, vino, olivas).",
        preparations: [
